...
class BunnyCDNClient
{
    ...
    public function list(string $path): array
    {
        try {
            ...
            if (!is_array($listing)) {
                throw new Exceptions\NotFoundException('File is not a directory');
            }
            ...
            throw match ($e->getCode()) {
                404 => new Exceptions\NotFoundException($e->getMessage()),
                default => new Exceptions\BunnyCDNException($e->getMessage())
            };
        }
    ...
    public function make_directory(string $path): mixed
    {
        try {
            ...
            throw match ($e->getCode()) {
                400 => new Exceptions\BunnyCDNException('Directory already exists'),
                default => new Exceptions\BunnyCDNException($e->getMessage())
            };
        }
        // @codeCoverageIgnoreEnd
    ...
    public function delete(string $path): mixed
    {
        try {
            ...
            throw match ($e->getCode()) {
                404 => new Exceptions\NotFoundException($e->getMessage()),
                400 => new Exceptions\DirectoryNotEmptyException($e->getMessage()),
                default => new Exceptions\BunnyCDNException($e->getMessage())
            };
        }
        // @codeCoverageIgnoreEnd
